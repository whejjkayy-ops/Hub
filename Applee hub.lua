...
v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://103625604878845", BackgroundTransparency = 0 },
                                    ...
                                    if not l_Character_7:FindFirstChild("Tushita") and not l_Backpack_1:FindFirstChild("Tushita") then
                                        if not v798 then
                                            game.StarterGui:SetCore("SendNotification", {
                                                ...
                                                con = "rbxassetid://103625604878845",
                                                Duration = 10
                                            })
                                            v798 = true
                                        end
