...
Window = Library:CreateWindow({
    Title = "Apple Hub",
    Desc = "- Blox Fruit",
    Image = "rbxassetid://103625604878845"
})
...
Library:Notify({
    Title = "Apple Hub",
    Description = "Chào mừng! UI màu hồng đã được load thành công.\Nhấn nút góc trái màn hình để mở GUI.",
    Duration = 4
})
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("www.tiktok.com/@drxt07"))
    end
})
...
-- ===============================================================
print('✅ Apple Hub - Tất cả tính năng đã được load!')